    ...
    <footer class="bg-white">
      <div class="mx-auto max-w-7xl px-6 pt-20 pb-8 sm:pt-24 lg:px-8 lg:pt-32">
        <div class="xl:grid xl:grid-cols-3 xl:gap-8">
          ...
          <div class="mt-10 xl:mt-0">
            ...
            <form class="mt-6 sm:flex sm:max-w-md">
              <HbInput type="email" placeholder="Enter your email" />
              <div class="mt-4 sm:mt-0 sm:ml-4 sm:shrink-0">
                <HbButton size="sm" variant="primary">Subscribe</HbButton>
              </div>
            </form>
          </div>
        </div>
        <div class="mt-16 border-t border-gray-900/10 pt-8 sm:mt-20 md:flex md:items-center md:justify-between lg:mt-24">
          ...
          <p class="mt-8 text-sm/6 text-gray-600 md:order-1 md:mt-0">&copy; {{ new Date().getFullYear() }} HireHub, Inc. All rights reserved.</p>
        </div>
      </div>
    </footer>
  </template>
